$(
    function () {
        ...
        if ( ! ck ) {
            $("body").append(
                "<section id='cookie'>\
                    Questo sito utilizza cookie tecnici per offrirti una migliore esperienza di navigazione sul sito. Se vuoi saperne di pi&uacute; visita la\
                    <a href='cookie_policy.html'>Policy</a> oppure \
